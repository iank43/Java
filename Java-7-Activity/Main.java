...
//    Challenge 7:  See file Actvy7_Eq7    (HINT: What does the "plus minus: after "-b" mean?)
      ...
      double posX = (-b + Math.sqrt(Math.pow(b,2)*a*c)/2*a);
      double negX = (-b - Math.sqrt(Math.pow(b,2)*a*c)/2*a);
      System.out.println("Value of posX is "+ posX); 
      System.out.println("Value of negX is "+ negX); 
